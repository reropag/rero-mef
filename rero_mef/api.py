...
class AuthRecord(Record):
    ...
    def create_or_update(
        ...
        **kwargs
        ...
        pid = data['identifier_for_person']
        agency_record = cls.get_record_by_pid(pid, with_deleted=False)

        from .authorities.api import ViafRecord
        viaf_record = ViafRecord.get_viaf_by_agency_pid(
            pid, pid_type=cls.agency_pid_type, with_deleted=False
        )
